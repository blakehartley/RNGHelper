...
namespace UnitTests
{
    ...
    public class CharacterTests
    {
        ...
        {
            Character character = new Character(3, 23, Spells.Cure, false);
        ...
        {
            Character character = new Character(3, 23, Spells.Cure, true);
        ...
        {
            Character character = new Character(3, 23, Spells.Cura, false);
        ...
        {
            Character character = new Character(3, 23, Spells.Cura, true);
